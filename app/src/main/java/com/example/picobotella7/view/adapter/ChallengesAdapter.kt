...
class ChallengesAdapter (private val  listChallenge:MutableList<Challenge>, private val editClickListener: OnEditClickListener):RecyclerView.Adapter<ChallengeViewHolder>() {
